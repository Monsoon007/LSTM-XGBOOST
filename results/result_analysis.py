...
def comparison_scatter_with_envelope(series1, series2, title='Scatter Plot with Fitting Lines', xlabel=None, ylabel=None, model_name1='Model 1', model_name2='Model 2',set1='Val',set2='Test',save=False, save_path='comparison_plot.png'):
    """
    ...
    # 绘制第一个数据集
    single_scatter_with_envelope(series1, 'blue', 'o', model_name=model_name1, set=set1,show=False)
    # 绘制第二个数据集
    single_scatter_with_envelope(series2, 'green', 'x', model_name=model_name2,set=set2,show=False)
